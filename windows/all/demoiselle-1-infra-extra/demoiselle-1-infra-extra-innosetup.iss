#define MyAppName "Demoiselle 1 Infra - Extras"
...
OutputDir=.
OutputBaseFilename=demoiselle-1-infra-extra-{#MyAppVersion}
Compression=lzma
...
[Icons]
Name: {group}\iReport 3.0; Filename: {app}\tool\ireport-3.0\iReport.exe
Name: {group}\SoapUI 4.0; Filename: {app}\tool\soapui-4.0\bin\soapui.bat; IconFilename: {app}\tool\soapui-4.0\bin\soapui32.ico
Name: {group}\SQuirreL 3.2; Filename: {app}\tool\squirrel-3.2\squirrel-sql.bat; IconFilename: {app}\tool\squirrel-3.2\icons\acorn.ico
